...
model = keras.models.load_model('/Users/ivoarasin/Desktop/Master/Semester Two/Adv. Analytics in Bus./pythonProjects/Assignment2/Python_Assignment2/modelV1.keras')

img_path = '/Users/ivoarasin/Desktop/Master/Semester Two/Adv. Analytics in Bus./pythonProjects/Assignment2/Assignment2DataInput/other/243378.jpg'

img_size = (256, 256, 3)


##########################
# Credit for entire code below belongs to "https://keras.io/examples/vision/integrated_gradients/"
# made by Author "fchollet"
##########################
...
img_black = get_img_array('/Users/ivoarasin/Desktop/black.png')

# 2. Keep a copy of the original image
img_black = np.copy(img_black[0]).astype(np.uint8)
...
def random_baseline_integrated_gradients(
    ...
    for run in range(num_runs):
        baseline = np.random.random(img_size) * 0.3  # 255
...
class GradVisualizer:
    ...
    def draw_outlines(
            self, attributions, percentage=99, connected_component_structure=np.ones((3, 3))  # prev, 50 was 90
    ):
